...
class Filemanager {
     ...
     function __construct(extraConfig = '') {
    ...
    // allow Filemanager to be used with dynamic folders
     ...
     function getvar(var, preserve = null) {
     ...
     function postvar(var, sanitize = true) {
     ...
     function get_file_info(path='', thumbnail = false) {
 ...
 * @param string path
 */
 function get_thumbnail_path(path) {
 ...
 */
 ...
 function sanitize(var, preserve = null) {
 ...
 */
 function expandPath(path, clean = false)
{
    todo  = explode('/', path);
    fullPath = []
