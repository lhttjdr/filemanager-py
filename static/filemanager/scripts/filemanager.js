...
var loadConfigFile = function (type) {
	...
	if(type == 'user') {
		var url = '/static/filemanager/scripts/filemanager.config.js';
	} else {
		var url = '/static/filemanager/scripts/filemanager.config.js.default'
	}
...
if($.urlParam('langCode') != 0 && file_exists ('/static/filemanager/scripts/languages/'  + $.urlParam('langCode') + '.js')) config.options.culture = $.urlParam('langCode');

var lg = [];
$.ajax({
  url: '/static/filemanager/scripts/languages/'  + config.options.culture + '.js',
  async: false,
  dataType: 'json',
...
$(function(){
	...
	if(config.edit.enabled) {
		loadCSS('/static/filemanager/scripts/CodeMirror/lib/codemirror.css');
		loadCSS('/static/filemanager/scripts/CodeMirror/theme/' + config.edit.theme + '.css');
		loadJS('/static/filemanager/scripts/CodeMirror/lib/codemirror.js');
		loadJS('/static/filemanager/scripts/CodeMirror/addon/selection/active-line.js');
		loadJS('/static/filemanager/scripts/CodeMirror/dynamic-mode.js');
	}
	...
	/** load searchbox */
	if(config.options.searchBox === true)  {
		loadJS("/static/filemanager/scripts/filemanager.liveSearch.min.js");
	} else {
		$('#search').remove();
	}
